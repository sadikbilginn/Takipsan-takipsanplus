            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__group" id="kt_subheader_search">
                        <span class="kt-subheader__desc" id="kt_subheader_total">@lang('portal.add_new_order')</span>
                    </div>
                </div>
                    ...
                    <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                        <div class="kt-portlet__head kt-portlet__head--lg">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">@lang('portal.add_new_order') <small> @lang('portal.form_text')</small></h3>
                            </div>
                        ...
                        <div class="kt-portlet__body">
                            <form class="kt-form order_form" id="order_form" action="{{ route('order.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <input type="number" class="form-control @error('item_count') is-invalid @enderror" name="item_count" value="{{ old('item_count') }}">
                                                        @error('item_count')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-9">
                                                        <select name="consignee_id" id="consignee_id" class="form-control @error('consignee_id') is-invalid @enderror">
                                                            ...
                                                            @foreach($consignees as $key => $value)
                                                                <option value="{{ $value->id }}" {{ $value->id == old('consignee_id') ? 'selected' : '' }}>{{ $value->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('consignee_id')
                                                            <div class="invalid-feedback">{{ $message }}</div>
