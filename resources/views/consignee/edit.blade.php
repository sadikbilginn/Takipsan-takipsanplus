            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form" id="consignee_form" action="{{ route('consignee.update', $consignee->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="row">
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $consignee->name) }}">
                                                    @error('name')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-3">
                                                    <input type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone', $consignee->phone) }}">
                                                    @error('phone')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address', $consignee->address) }}">
                                                    @error('address')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control @error('auth_name') is-invalid @enderror" name="auth_name" value="{{ old('auth_name', $consignee->auth_name) }}">
                                                    @error('auth_name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-3">
                                                    <input type="text" class="form-control @error('auth_phone') is-invalid @enderror" name="auth_phone" value="{{ old('auth_phone', $consignee->auth_phone) }}">
                                                    @error('auth_phone')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-9">
                                                    <select name="companies[]" id="companies" multiple="multiple" class="form-control select @error('companies') is-invalid @enderror">
                                                        @foreach($companies as $key => $value)
                                                            <option value="{{ $value->id }}" {{ isset($consignee->companies) && in_array($value->id, old('companies', $consignee->companies->pluck('id')->toArray())) ? 'selected="selected"' : ''}}>{{ $value->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('companies')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-9">
                                                    <select name="viewid" class="form-control @error('view') is-invalid @enderror">
                                                        ...
                                                        @foreach($viewScreen as $value)
                                                            <option 
                                                                value="{{ $value->id }}" 
                                                                {{$consignee->viewid == $value->id ? 'selected="selected"' : ''}}
                                                            >
                                                                {{$value->name}}
                                                            </option>
                                                        @endforeach
                                                ...
                                                <div class="col-9">
                                                    <select name="sayfa_gorunum" class="form-control @error('sayfa_gorunum') is-invalid @enderror">
                                                        ...
                                                        @foreach(config('settings.form_static.sayfa_gorunum') as $key => $value)
                                                            <option value="{{ $key }}" {{ old('sayfa_gorunum', $consignee->sayfa_gorunum) == $key ? 'selected' : '' }}>@lang($value)</option>
                                                        @endforeach
                                                    </select>
                                                    @error('sayfa_gorunum')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-9">
                                                    <select name="status" class="form-control @error('status') is-invalid @enderror">
                                                        ...
                                                        @foreach(config('settings.form_static.status') as $key => $value)
                                                            <option value="{{ $key }}" {{ old('status', $consignee->status) == $key ? 'selected' : '' }}>@lang($value)</option>
                                                        @endforeach
                                                    </select>
                                                    @error('status')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    <div class="mt-2">
                                                        <img id="logo_prev" src="{{ config('settings.media.consignees.full_path') . $consignee->logo }}" width="100" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
