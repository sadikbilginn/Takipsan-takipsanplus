                ...
                <div class="col-lg-12">
                    ...
                    <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                            ...
                            <div class="kt-portlet__head-toolbar">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-brand"
                                            onclick="document.getElementById('consignment_form').submit();">
                        ...
                        <div class="kt-portlet__body">
                            <form class="kt-form" id="consignment_form" action="{{ route('tsukalists.update', $countingList->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                {{ method_field('PATCH') }}
                                <div class="row">
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">                                               
                                                <div class="form-group row">
                                                    <label class="col-3 col-form-label">Counting List</label>
                                                    <div class="col-9">
                                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $countingList->name) }}">
                                                        @error('name')
