        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__desc">@lang('portal.shipment') Dashboard</span>
                </div>
                {{-- 
                <div class="kt-subheader__toolbar">
                    <!-- Eğer üretim tipinde cihaz tanımı varsa-->
                    <a href="{{ route('production') }}" class="btn btn-brand btn-sm btn-upper btn-bold">
                        <i class="fa fa-search"></i>@lang('portal.manufacture_tracking')</a>
                </div>
                --}}
            </div>
        </div>
                            ...
                            <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                                @if(isset($log_activity))
                                    @foreach($log_activity as $key => $value)
                                        ...
                                        @if(in_array($value2->created_user->company->id,$companiesOfAnaUretici))
