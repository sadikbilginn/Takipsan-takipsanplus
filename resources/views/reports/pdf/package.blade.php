...
<div class="content">
    ...
    <h3 style="text-align: center;">@lang('portal.package_list')</h3>
        ...
        <table cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                @foreach($consignment->packages as $key => $value)
                    <td>
                        <b>@lang('portal.package') {{ $value->package_no }}</b> : {{ count($value->items) }} @lang('portal.piece')
                    </td>
                    @if(($key + 1) %5 == 0)
            </tr>
            <tr>
                ...
                @if($consignment->packages_count > 5)
                    @for($i=0; $i<tdCompletion($consignment->packages_count, 5); $i++)
                        <td></td>
                    @endfor
                @endif
            </tr>
