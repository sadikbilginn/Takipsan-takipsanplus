        ...
        <div class="content">
            ...
            <table>
                <tr>
                        ...
                        <table style="width:%50" class="table-main border-table">
                            <tbody>
                                <tr class="table-header">
                                    ...
                                    <td>Msrmnt (cm)</td>
                                    <td>Total (Qty)</td>
                                    <td rowspan="">Art no</td>
                                </tr>
                                @foreach ($packageTypes as $key => $value)
                                <tr>
                                    <td>{{$key}}</td>
                                    <td>{{getPackageMsmrnt($boxTypes,$key)}}</td>
                                    <td>{{getPackageTypeCount($consignment->packages,$key)}}</td>
                                    <td class="">{{$artNo}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td colspan="2">Ctns/Col</td>
                                <td rowspan="2">Qty/Col</td>
                                <td rowspan="2">Asst/Col</td>
                            </tr>
                            <tr>
                                <td>Solid</td>
                                <td>Asst</td>
                            ...
                            <tr>
                                ...
                                <td>{{$totalCount}}</td>
                                <td>{{getAssrCount($consignment->packages)}}</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    Mixed : {{getPackageCountByLT($consignment->packages,"SolidLast")}}
                                </td>
                                <td  colspan="2">Pcs incl. in totals</td>
                            </tr>
                            <tr>
                                <td colspan="2">{{count($consignment->packages)}}</td>
                                <td>{{$totalCount}}</td>
                                <td>{{getAssrCount($consignment->packages)}}</td>
                            </tr>
                        </table>
            ...
            <table class="table-main border-table">
                <tr class="table-header">
                    ...
                    <td colspan="{{count($sizes)}}" style="text-align: center;">Solid pcs per size</td>
            ...
            <table class="table-main border-table">
                <tr class="table-header">
                    ...
                    <td colspan="{{$assortCount}}" style="text-align: center;">
                        Asst: Total pcs per article (colour) and size
                    </td>
            ...
            <table class="table-main border-table">
                <tr class="table-header">
                    <td rowspan="2">Art no</td>
                    <td rowspan="2">Items/Asst</td>
                    <td colspan="{{$solidCnt}}" style="text-align: center;">
                        Asst: Total pcs per article (colour) and size
                    </td>
                    <td rowspan="2" style="text-align: center;">Asst: Total pcs / Article (col) </td>
                </tr>
            ...
            <table class="table-main border-table">
                <tr class="table-header">
                    <td rowspan="2">Art no</td>
                    <td rowspan="2">Items/Asst</td>
                    <td colspan="{{$sLCount}}" style="text-align: center;">
                        Asst: Total pcs per article (colour) and size
                    </td>
                    <td rowspan="2" style="text-align: center;">Asst: Total pcs / Article (col) </td>
                </tr>
