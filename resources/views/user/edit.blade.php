                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        >
                                                            ...
                                                            <option 
                                                                value="{{ $val->id }}" 
                                                                {{ 
                                                                    isset($userSelectRoles) && 
                                                                    in_array($val->id, $userSelectRoles) ? 
                                                                        'selected="selected"' : ''
                                                                }}
                                                            >
                                                                {{ $val->title }}
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        >
                                                            ...
                                                            <option 
                                                                value="{{ $val->id }}" 
                                                                {{ 
                                                                    isset($selectedCustomPermission) && 
                                                                    in_array($val->id, $selectedCustomPermission) ? 
                                                                        'selected="selected"' : ''
                                                                }}
                                                            >
                                                                {{ $val->name }}
                        ...
                        @foreach($permissions as $key => $value){
                            ...
                            "children" : [
                                @foreach($value as $key2 => $value2){
                                    ...
                                    "text" : "{{ $value2->title }}",
                                    "icon" : "fa fa-file",
                                    @if(isset($userSelectPermission) && in_array($value2->id, $userSelectPermission))
                                    'state' : {
                                        'selected' : true
                                    },
                                    @endif
