                            ...
                            <div class="kt-widget17__stats">
                                ...
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item">
                                        ...
                                        <a href="javascript:;">
                                            <span class="kt-widget17__subtitle">@lang('portal.main_companies')</span>
                            ...
                            <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                                @if(isset($log_activity))
                                    @foreach($log_activity as $key => $value)
                                        ...
                                        @if(in_array($value2->created_user->company->id,$companiesOfPartner))
                                            <div class="kt-timeline-v2__item">
                                                ...
                                                <div class="kt-timeline-v2__item-text  kt-padding-top-5">
                                                    ...
                                                    @if($value2->created_user)
                                                        <br>
                                                        <small>{{ $value2->created_user->username }}</small>
