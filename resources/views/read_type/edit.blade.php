        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                    <span class="kt-subheader__desc" id="kt_subheader_total">@lang('portal.edit_read_type')</span>
                </div>
            </div>
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title"> @lang('portal.edit_read_type') <small> @lang('portal.form_text')</small></h3>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form" id="read_type_form" action="{{ route('read-type.update', $read_type->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="row">
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $read_type->name) }}">
                                                    @error('name')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ old('name_en', $read_type->name_en) }}">
                                                    @error('name_en')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-9">
                                                    <select name="reader" class="form-control @error('reader') is-invalid @enderror">
                                                        ...
                                                        @foreach(config('settings.readers') as $key => $value)
                                                            <option value="{{ $key }}" {{ old('reader', $read_type->reader) == $key ? 'selected' : '' }}> {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('reader')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-9">
                                                    <select name="reader_mode" id="reader_mode" class="form-control @error('reader_mode') is-invalid @enderror">
                                                        ...
                                                        @foreach(config('settings.reader_mode') as $key => $value)
                                                            <option value="{{ $key }}" {{ old('reader_mode', $read_type->reader_mode) == $key ? 'selected' : '' }}> {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('reader_mode')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input type="number" name="estimated_population" id="estimated_population" class="form-control @error('estimated_population') is-invalid @enderror" min="0"  value="{{ old('estimated_population', $read_type->estimated_population) }}">
                                                ...
                                                <div class="col-9">
                                                    <select name="search_mode" id="search_mode" class="form-control @error('search_mode') is-invalid @enderror">
                                                        ...
                                                        @foreach(config('settings.search_mode') as $key => $value)
                                                            <option value="{{ $key }}" {{ old('search_mode', $read_type->search_mode) == $key ? 'selected' : '' }}> {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('search_mode')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-9">
                                                    <select name="session" id="session" class="form-control @error('session') is-invalid @enderror">
                                                        ...
                                                        @foreach(config('settings.reader_session') as $key => $value)
                                                            <option value="{{ $key }}" {{ old('session', $read_type->session) == $key ? 'selected' : '' }}> {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('session')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <textarea name="string_set" id="string_set" cols="30" rows="10" class="form-control @error('name') is-invalid @enderror">{{ old('string_set', $read_type->string_set) }}</textarea>
                                                    @error('string_set')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <span class="kt-switch kt-switch--lg kt-switch--outline kt-switch--icon kt-switch--success  @error('status') is-invalid @enderror">
                                                        <label>
                                                            <input type="checkbox" {{ $read_type->status == true ? 'checked="checked"' : '' }} name="status" id="status">
                                                            <span></span>
                                                        </label>
                                                     </span>
                                                    @error('status')
