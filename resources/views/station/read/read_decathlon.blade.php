                ...
                <div class="table-ss">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>@lang('station.package')</th>
                            <th>@lang('station.package_type')</th>
                            <th>@lang('station.description')</th>
                            <th>@lang('station.load_type')</th>
                            <th style="text-align: center;">@lang('station.count')</th>
                            <th style="text-align: center;">@lang('station.size')</th>
                            <!-- <th>@lang('station.order_no')</th>
                            <th>@lang('station.season')</th>
                            <th>@lang('station.product_no')</th>
                            <th>@lang('station.variant')</th>
                            <th>GTIN</th>
                            <th>@lang('station.article_number')</th>
                            <th>@lang('station.sds_code')</th>
                            <th>@lang('station.description')</th>
