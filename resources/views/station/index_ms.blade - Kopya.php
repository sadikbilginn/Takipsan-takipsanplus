...
@section('headScripts')
    <script type="text/javascript">
        ...
        var barcode_port = '{{ session('device.barcode_port') }}';
        ...
        function readBarcode(barcodeValue) {
            ...
            axios({
                ...
                if (response.data.status == 'ok' && $('#consignments').val()) {
                    ...
                    sweetAlert('@lang('station.barcode_not_warning')', '', 'warning', "@lang('station.ok')");
