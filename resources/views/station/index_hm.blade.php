        ...
        function insertRow(packageNo,package){
            ...
            if(package && package.items){
                ...
                if(packageRow.length > 0){
                    ...
                    '<td onclick="typesEdit(this)" id="ptype_' + package.id + '">' +
                        (package.box_type_id ? package.box_type_id : currentPType) +
                    '</td>' +
                    '<td id="description_' + package.id + '">' + (prod ? prod.description : 'UND') + '</td>' +
                    '<td onclick="typesEdit(this)" id="loadtype_' + package.id + '">' +
                        (package.load_type  ? package.load_type : currentLType) +
                    '</td>' +
                    '<td id="count_' + package.id + '">' + package.itemsCount + '</td>' +
                    '<td id="size_' + package.id + '">' +  package.size.replace(/,\s*$/, "")  + '</td>' +
                    '</tr>';
