        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                    <span class="kt-subheader__desc" id="kt_subheader_total">@lang('portal.add_new_role')</span>
                </div>
            </div>
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">@lang('portal.add_new_role') <small> @lang('portal.form_text')</small></h3>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form" id="role_form" action="{{ route('role.store') }}" method="post">
                            @csrf
                            <div class="row">
