        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{ route('company.show', $device->company->id) }}" class="kt-subheader__breadcrumbs-link">{{ $device->company->name }}</a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form" id="device_form" action="{{ route('company.device.update', $device->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="row">
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <select name="reader_mode" id="reader_mode" class="form-control @error('status') is-invalid @enderror">
                                                        <option value="" selected>@lang('portal.choose')</option>
