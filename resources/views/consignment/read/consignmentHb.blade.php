<form action="#" method="post" id="consigmentHbStore">
    @csrf
    <div class="form-group row">
        <label class="col-3 col-form-label" for="po_no">@lang('station.country')</label>
        <div class="col-9">
    ...
    <div class="form-group row">
        <label class="col-3 col-form-label" for="consignee_id">@lang('station.upload_list_xls') :</label>
        <div class="col-9">
            <input type="file" id="db_list" name="db_list" accept=".xlsx">
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#consignmentSubmitBtn").on('click', function (){
            ...
            var btn = $(this);
            btn.hide();
            var form = document.querySelector('#consigmentHbStore');
            var data = new FormData(form);
            data.append('process', 'consigmentHbStore');
