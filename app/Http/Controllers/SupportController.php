...
class SupportController extends Controller{
    ...
    */
    public function create(){
        ...
        $this->data['company'] = Company::where('status', true)->orderBy('id', 'ASC')->get();
        $this->data['device'] = Device::all();
        $this->data['support'] = DB::table('supports')->orderBy('id', 'ASC')->get();

        return view('support.create', $this->data);
