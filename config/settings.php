...
return [
     ...
     * Title.
     */
    'title' => 'Fason Portal | Takipsan RFID',
    ...
    /*
     * Takipsan ana çatı uygulama adresi.
     */
    'main_host_api' => [
        'company_code'  => env('COMPANY_CODE', NULL),
        'permission'    => 'http://system.takipsanrfid.com/api/company/permission',
        'license'       => 'http://system.takipsanrfid.com/api/company/license',
    ],

    /*
     * Roller arayüz(view) eşleşmesi. Db ile aynı olmalı
     */
    'roles' => [
        'anaUretici'    => 5,
        'uretici'  => 2,
    ...
    'readers' => [
        ...
        'hopeland'      => 'HopeLand',
        'ChainWayRead'  => 'ChainWayRead',
    ],
    
    /*
     * Device İşlevleri . Db ile aynı olmalı
     */
    'device_aims' => [
        1        => 'portal.manufacture',
        2        => 'portal.shipment',
    ],
    ...
    'reader_mode' => [
        ...
        'Hybrid'                        => 'Hybrid',
        'DenseReaderM4'                 => 'Dense Reader M4',
        'DenseReaderM8'                 => 'Dense Reader M8',
        'MaxMiller'                     => 'Max Miller',
        'DenseReaderM4Two'              => 'Dense Reader M4 Two	',
        'AutoSetDenseReader'            => 'AutoSet Dense Reader',
        'AutoSetDenseReaderDeepScan'    => 'AutoSet Dense Reader Deep Scan',
        'AutoSetStaticFast'             => 'AutoSet Static Fast',
        'AutoSetStaticDenseReader'      => 'AutoSet Static Dense Reader',
        'ImpinjInternal'                => 'Impinj Internal',
    ],
    ...
    'search_mode' => [
        ...
        'SingleTargetB'     => 'SingleTargetB',
        'DualTargetBtoA'    => 'DualTargetBtoA',
    ],
    ...
    'devices' => [
        'box_station' => [
            'logo' => '/assets/media/devices/box_station.png',
            'name' => 'Box Station',
        ],
        'box_station2' => [
            'logo' => '/assets/media/devices/box_station2.png',
            'name' => 'Box Station 2',
        ],
        'donkey_station' => [
            'logo' => '/assets/media/devices/donkey_station.png',
            'name' => 'Donkey Station',
        ],
        'gate_station' => [
            'logo' => '/assets/media/devices/donkey_station.png',
        ...
        'tunnel_station' => [
            'logo' => '/assets/media/devices/tunnel_station.png',
            'name' => 'Tunnel Station',
        ],
        'big_desk_station' => [
            'logo' => '/assets/media/devices/bigdesk_station.png',
            'name' => 'Big Desk Station',
        ],
        'rf_prizma' => [
            'logo' => '/assets/media/devices/rf-prizma.png',
            'name' => 'RF Prizma',
        ]
    ],
    ...
    'media' => [
        ...
        [
           'root_path' => 'upload' ,
           'path'      => 'images/devices/',
           'full_path' => 'upload/images/devices/'
        ],
        'companies' =>
        [
           'root_path' => 'upload' ,
           'path'      => 'images/companies/',
           'full_path' => 'upload/images/companies/'
        ],
        'facilities' =>
        [
           'root_path' => 'upload' ,
           'path'      => 'images/facilities/',
           'full_path' => 'upload/images/facilities/'
        ],
        'consignees' =>
        [
           'root_path' => 'upload' ,
           'path'      => 'images/consignees/',
           'full_path' => 'upload/images/consignees/'
        ],
        'files' =>
        [
            'root_path' => 'upload' ,
            'path'      => 'files/ms/',
            'full_path' => 'upload/files/ms/'
        ]
    ],
